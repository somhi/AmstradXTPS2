...
/////// AmstradXTPS2.ino
/////// 
/////// PS/2 TO AMSTRAD XT (PC1512/PC1640/...) KEYBOARD CONVERTER
///////
/////// Should work with: Amstrad PC1512 / PC1640 / PC2086 / PC3086. 
/////// Tesded Platforms: PC1512
///////
/////// Please add https://github.com/techpaul/PS2KeyAdvanced Arduino library to compile.
///////
/////// Code based on PS/2 to XT keyboard converter https://github.com/kesrut/pcxtkbd
/////// http://www.ccgcpu.com/2019/02/14/the-xt-part-4-adapting-a-modernish-keyboard/#How_the_XT_protocol_and_keyboards_work
///////
/////// Amstrad PC1512 Protocol documentation:
/////// https://www.seasip.info/AmstradXT/pc1512kbd.html
/////// http://www.kbdbabel.org/signaling/index.html
///////
/////// Versions:
/////// 0.1 initial working version (30/04/21)
///////
///////
////////////////////////////////////////////////////////////////////
...
{ 
   while (digitalRead(xt_data) != HIGH) ; //ACK when xt_data=HIGH to send new keystroke 
...
void setup() 
{
  ...
  // to avoid initial error at BIOS keyboard check
  delay(15000) ;    
  _write(0xAA) ;
  delay(5000) ;    
  _write(0xAA) ;
  delay(5000) ;    
  _write(0xAA) ;
  // add more delay _write if you still get stuck on initial BIOS keyboard error 
}
